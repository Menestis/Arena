...
public class ChangeMapTask extends BukkitRunnable {
    ...
    @Override
    public void run() {
        Bukkit.broadcastMessage("§6§lPyralia §8§l» §7Vote pour pour changer d'arène: §8(§6Automatique§8)");
        ...
        Tasks.runLater(()->{
            ...
            Tasks.runLater(()->{
                Bukkit.broadcastMessage("§6§lPyralia §8§l» §7Vote pour le changement d'arène §cterminé§7.");
                Bukkit.broadcastMessage("");
